...
export const EditorData = () => (
  <div>
    <h3>You can write anything you want here in the Editor app. This is just some placeholder text — feel free to delete it! I created this website to strengthen my React skills and to gain experience with tools like Tailwind CSS, Syncfusion, and more.</h3>
    <h3>Thank you for visiting Dashboard! 📊 🎉</h3>
  </div>
);
